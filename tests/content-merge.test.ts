...
describe("content-merge", () => {
  describe("threeWayMerge", () => {
    ...
    it("should conflict when both sides change the same frontmatter field", () => {
      ...
      const local = ["---", "title: Local Title", "slug: my-post", "---", "", "Body content."].join(
        "\n"
      );
    ...
    it("should auto-merge non-overlapping JSON property changes", () => {
      const base = JSON.stringify(
        { id: 1, title: "Original", description: "Desc", body: "Content" },
        null,
        2
      );
      const local = JSON.stringify(
        { id: 1, title: "Local Title", description: "Desc", body: "Content" },
        null,
        2
      );
      const remote = JSON.stringify(
        { id: 1, title: "Original", description: "Desc", body: "Updated Content" },
        null,
        2
      );
  ...
  describe("isLocallyModified", () => {
    ...
    it("should ignore trailing zeros in various timestamp fields", () => {
      const base =
        '{"createdAt": "2026-02-10T13:34:55.7102880Z", "updatedAt": "2026-02-13T10:32:20.29398360Z"}';
      const local =
        '{"createdAt": "2026-02-10T13:34:55.710288Z", "updatedAt": "2026-02-13T10:32:20.2939836Z"}';
      expect(isLocallyModified(base, local)).toBe(false);
    });
  });
  ...
  describe("threeWayMergeJson", () => {
    ...
    it("should always take remote updatedAt even when local also changed it", () => {
      const base = JSON.stringify(
        { id: 1, updatedAt: "2026-01-01T00:00:00Z", title: "T" },
        null,
        2
      );
      const local = JSON.stringify(
        { id: 1, updatedAt: "2026-01-15T00:00:00Z", title: "T" },
        null,
        2
      );
      const remote = JSON.stringify(
        { id: 1, updatedAt: "2026-02-01T00:00:00Z", title: "T" },
        null,
        2
      );
