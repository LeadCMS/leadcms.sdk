...
describe("Type-specific find*ByRemoteId wrappers", () => {
  ...
  it("findEmailTemplateByRemoteId returns name", () => {
    expect(findEmailTemplateByRemoteId(map, 10)).toEqual({
      language: "en-US",
      name: "WS_Register",
    });
    expect(findEmailTemplateByRemoteId(map, 12)).toEqual({
      language: "ru-RU",
      name: "WS_Contact_Us",
    });
  ...
  it("findSequenceByRemoteId returns name and language", () => {
    expect(findSequenceByRemoteId(map, 100)).toEqual({
      language: "ru-RU",
