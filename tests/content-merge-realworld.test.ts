...
import { threeWayMergeJson, isLocallyModified } from "../src/lib/content-merge";
...
const localFileContent = JSON.stringify(
  {
    cookieBanner: {
      message:
        "We use cookies to improve your experience and measure site usage. Learn more in our",
      policyLinkLabel: "Privacy Policy",
      policyLinkHref: "/legal/privacy",
      acceptLabel: "Accept1",
